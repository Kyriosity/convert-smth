...
const namings: { [id in keyof typeof AircraftBuilders]?: entityNaming; } = {
    ...
    Aerospatiale: { short: 'Aérospatiale', details: 'french company which in cooperation with BAC have fulfilled Concorde program' },
