...
const namings: { [id in keyof typeof AircraftBuilders]?: naming; } = {
    ...
    Diamond: { short: 'Diamond', full: 'Diamond Aircraft Industries GmbH', details: 'manufacturer of general aviation aircraft and motor gliders, based in Austria. It is the third largest manufacturer of aircraft for the general aviation sector.'},
    Dornier: { short: 'Dornier', full: 'Dornier Luftfahrt GmbH' },
    ...
    Fokker: { short: 'Fokker' },
    GAF: { short: 'GAF', full: '', details: 'Aircraft manufacturer owned by the Government of Australia. ' },
    ...
    Honda: { short: 'Honda', full: 'Honda Aircraft Company', details: 'A wholly owned subsidiary of the Honda Motor Company that has developed the prototype HondaJet and is slated to manufacture and market the production version of the aircraft.' },
    ...
    Nihon: { short: 'NAMC', full: ' Nihon Aircraft Manufacturing Corporation ', details: 'NACM was actually a consortium of several different manufacturing companies and university professors, founded with the goal of designing and manufacturing a Japanese civilian turboprop airliner.'},
    Piaggio: { short: 'Piaggio', full: 'Piaggio Aerospace Società per Azioni', details: ' Multinational aerospace manufacturing company, which designs, develops, manufactures and maintains aircraft, aero-engines, aerospace components and aerostructures.' },
    Pilatus: { short: 'Pilatus', full: 'Pilatus Aircraft Ltd.', details: 'Aerospace manufacturer located in Stans, Switzerland. The company has mostly produced aircraft for niche markets, in particular short takeoff and landing aircraft'},
