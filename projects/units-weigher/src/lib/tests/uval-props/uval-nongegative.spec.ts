// import { UValErr, MSG_VALUE_CANTBE_NEGATIVE, } from '../../core/z_barrel';
...
//         expect(function () { subj.val = -1 }).toThrow(new UValErr(MSG_VALUE_CANTBE_NEGATIVE))
//     });

//     it(`instantiating non-negative w/ minus value throws`, () => {
//         expect(function () { meter(-100) }).toThrow(new UValErr(MSG_VALUE_CANTBE_NEGATIVE))
//     })
...
//         expect(function () { rankine(-100) }).toThrow(new UValErr(MSG_VALUE_CANTBE_NEGATIVE))
//     })
// })
